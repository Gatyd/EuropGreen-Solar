...
<template>
    <section ref="heroRef" class="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <!-- Titre principal -->
            <h1 class="hero-title text-5xl sm:text-6xl lg:text-7xl font-extrabold text-white mb-6 tracking-tight">
                Pilotez votre projet solaire
                <span class="block mt-2 bg-gradient-to-r from-white to-primary-200 bg-clip-text text-transparent">
                    en toute simplicité
                </span>
            </h1>
            ...
            <!-- Sous-titre -->
            <p
                class="hero-subtitle text-lg sm:text-xl lg:text-2xl text-white/90 mb-10 max-w-3xl mx-auto leading-relaxed">
            ...
            <div class="hero-cta flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
                <UButton size="xl" color="neutral" variant="solid" icon="i-heroicons-arrow-down"
                    @click="scrollTo('#installation')" class="shadow-xl hover:shadow-2xl transition-shadow">
                    Découvrir les fonctionnalités
                </UButton>
                <UButton size="xl" color="primary" variant="outline" to="/login"
                    icon="i-heroicons-arrow-right-end-on-rectangle" trailing
