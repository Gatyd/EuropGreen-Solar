...
async function handleExport() {
    ...
    // Si un commercial est sélectionné, on l'ajoute aux paramètres
    if (form.salesperson_id) {
        params.salesperson_id = form.salesperson_id
    }

    await downloadFile('/api/admin-platform/reports/sales-report/', undefined, params)
            ...
            <UCard>
                <template #header>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2">
                            ...
                            <h3 class="text-lg font-semibold">Rapport des Ventes</h3>
                        </div>
                ...
                <div class="space-y-4">
                    ...
                    <p class="text-sm text-gray-600">
                        Générez un rapport détaillé des ventes avec CA total, évolution mensuelle et statistiques par
                        commercial.
                    </p>
                    ...
                    <div class="grid grid-cols-10 gap-5">
                        ...
                        <UFormField label="Commercial (optionnel)" class="col-span-10 sm:col-span-4">
                            <UserSelectMenu v-model="form.salesperson_id" role-filter="sales"
                                placeholder="Tous les commerciaux" class="w-full" />
                        </UFormField>
                    </div>
                    ...
                    <UAlert icon="i-heroicons-information-circle" color="primary" variant="subtle"
                        ...
                        description="CA total, nombre de devis signés, ticket moyen, répartition par commercial, évolution mensuelle" />
                </div>
                ...
                <template #footer>
                    <div class="flex items-center justify-end gap-3">
                        <UButton color="neutral" variant="outline" label="Annuler" @click="model = false"
                            :disabled="loading" />
                        <UButton color="primary" icon="i-heroicons-table-cells" label="Télécharger Excel"
