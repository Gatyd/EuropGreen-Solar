...
from .views import EnedisMandatePreviewAPIView
...
urlpatterns = [
    ...
    path("administrative/enedis-mandate/preview/", EnedisMandatePreviewAPIView.as_view(), name="preview-enedis-mandate"),
]
