...
class Cerfa16702(models.Model):
    ...
    # Pièces Jointes (DPC)
    dpc1 = models.FileField(upload_to="administrative/cerfa16702/dpc/", null=True, blank=True)
    dpc2 = models.FileField(upload_to="administrative/cerfa16702/dpc/", null=True, blank=True)
    dpc3 = models.FileField(upload_to="administrative/cerfa16702/dpc/", null=True, blank=True)
    dpc4 = models.FileField(upload_to="administrative/cerfa16702/dpc/", null=True, blank=True)
    dpc5 = models.FileField(upload_to="administrative/cerfa16702/dpc/", null=True, blank=True)
    dpc6 = models.FileField(upload_to="administrative/cerfa16702/dpc/", null=True, blank=True)
    dpc7 = models.FileField(upload_to="administrative/cerfa16702/dpc/", null=True, blank=True)
    dpc8 = models.FileField(upload_to="administrative/cerfa16702/dpc/", null=True, blank=True)
    dpc11 = models.FileField(upload_to="administrative/cerfa16702/dpc/", null=True, blank=True)
